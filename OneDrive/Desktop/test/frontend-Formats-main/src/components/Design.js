...
export default function Design() {
  return (
    ...
    <div className="jarallax-img" style={{backgroundImage: 'url(assets/img/landing/corporate/design.jpg'}}></div>
    <div className="container position-relative zindex-2 pt-5 pb-md-2 pb-lg-3 pb-xl-4 pb-xxl-5">
      ...
      <h1 className="display-2 mb-4">Новое направление! <br/> Графический ДИЗАЙН за 68 часов</h1>
      ...
      <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-4 pb-1 pb-md-3">
        ...
        <div className="col">
          <div className="d-flex align-items-center">
            ...
            <h3 className="h5 ps-3 mb-0">Шаг за шагом развивайся</h3>
          </div>
        </div>
        {/* <div className="col">
          <div className="d-flex align-items-center">
        ...
        <div className="row align-items-center py-4 py-xl-5 my-2">
          ...
          <div className="col-md-6 col-xl-5 order-md-1">
            <div className="pe-md-4 pe-xl-0">
              ...
              Для подростков (16+) и взрослых:
                </h2>
              <ol className="fs-lg"> Изучение программ:
             ...
             <p className="fs-lg">
             Вы можете записаться на индивидуальные занятия или в мини-группы. <br/>
             Портфолио для начала карьеры дизайнера по итогу обучения!</p> 
